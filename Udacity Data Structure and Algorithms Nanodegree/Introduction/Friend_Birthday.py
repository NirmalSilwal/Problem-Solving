...
def get_april_birthdays(people):
    ...
    for individual in people:
        if individual.birthday_month == 'April':
            individual.age += 1
            april_birthdays[individual.name] = individual.age
...
def get_most_common_month(people):
    ...
    for individual in people:
        months[individual.birthday_month] += 1
...
test()
# Expected result:
# {'Michael': 11, 'Erica': 72, 'Carol': 36, 'Lisa': 37, 'Lawrence': 87, 'Joseph': 25, 'Margaret': 35,
# 'Andrew': 13, 'Dusty': 53, 'Robert': 89}
# August
